...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 23.1.3](https://hub.docker.com/r/clickhouse/clickhouse-server/).
