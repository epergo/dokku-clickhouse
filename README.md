...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 22.1.3](https://hub.docker.com/r/clickhouse/clickhouse-server/).
